...
# Taken from https://github.com/AHupuJR/EFNet/blob/main/basicsr/metrics/psnr_ssim.py
...
# crop_border = 0
#
# # For psnr call this function
# # Score of infinity for identical image
# psnr = calculate_psnr(img1, img2, crop_border, input_order='HWC', test_y_channel=False)
#
# print("PSNR = ", psnr)
#
# # For ssim, call this function
# # Score of 1.0 for idential image and 0 for dissimilar
# ssim = calculate_ssim(img1, img2, crop_border, input_order='HWC', test_y_channel=False)
# print("SSIM = ", ssim)